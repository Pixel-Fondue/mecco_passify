...
class cmd_passify_activate(lxu.command.BasicCommand):
    ...
    def cmd_Execute(self,flags):
        ...
        if item_id == passify.NONE:
            graph_kids = passify.fetch_by_tag(passify.ULTRALIGHT_PGRP,type_='renderPassGroups').itemGraph('itemGroups').forward()
...
lx.bless(cmd_passify_activate, passify.CMD_ULTRALIGHT_ACTIVATE)
